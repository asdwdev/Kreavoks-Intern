  ...
  return (
    <AppLayout>
      ...
      <div className="flex min-h-screen flex-col bg-white text-black">
        {/* Hero Section */}
        <section className="relative py-20 overflow-hidden bg-[radial-gradient(#e5e7eb_2px,transparent_2px)] [background-size:16px_16px]">
          {/* Overlay */}
            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
              ...
              <div>
                ...
                <div className="flex items-center gap-4">
                  <img src="/images/team/setiady.png" alt="Founder" className="w-16 h-16 rounded-full object-cover" />
                  <div>
