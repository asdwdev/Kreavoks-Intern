    ...
    return (
        <AppLayout>
            ...
            >
                ...
                <section ref={heroRef} className="relative py-16 overflow-hidden bg-[radial-gradient(#e5e7eb_2px,transparent_2px)] [background-size:16px_16px] opacity-0">
                    {/* Overlay */}
                    ...
                    <div className="container mx-auto px-6 md:px-12 lg:px-16 relative z-10">
                        <div className="max-w-3xl mx-auto text-center">
                            ...
                            <div className="flex flex-col sm:flex-row gap-4 justify-center">
                                ...
                                <button className="px-6 py-3 border border-blue-500 text-blue-500 font-semibold rounded-full hover:bg-blue-50 cursor-pointer hover:scale-105 transition duration-300">
                                    Konsultasi Gratis
                                </button>
                            </div>
                        </div>
                    ...
                    <div className="flex flex-col sm:flex-row justify-between items-start sm:items-center gap-4 mb-8">
                        <div className="flex gap-4 p-1 bg-gray-100 rounded-full">
                            <button
                                ...
                                className={`px-6 py-2 rounded-full text-sm font-medium transition-all duration-300 ${activeTab === "courses" ? "bg-blue-500 text-white shadow-md" : "cursor-pointer text-gray-600 hover:bg-gray-200"
                                    }`}
                            >
                                Courses
                            </button>
                            <button
                                ...
                                className={`px-6 py-2 rounded-full text-sm font-medium transition-all duration-300 ${activeTab === "events" ? "bg-blue-500 text-white shadow-md" : "cursor-pointer text-gray-600 hover:bg-gray-200"
                                    }`}
                            >
                                Events
                            </button>
