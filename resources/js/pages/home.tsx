...
// Types
import type { Course, Event, ServicePackage, Testimonial, SharedData, Mentor } from "@/types"
    ...
    return (
        <AppLayout>
            ...
            >
                    ...
                    <div className="container mx-auto grid grid-cols-1 md:grid-cols-2 md:items-center gap-8 relative z-10">
                        ...
                        <div className="px-6 md:px-12 lg:px-16 py-12 flex flex-col items-start gap-4">
                            <p className="text-blue-500 text-md md:text-base">
                                <span className="font-bold">No.1</span> Agensi Digitalisasi dan Pemberdayaan Skill
                            </p>
                            <h1 className="text-6xl md:text-6xl lg:text-7xl font-bold text-black leading-tight transition-transform duration-700 hover:scale-105">
                                Masa Depan <span className="text-blue-500">Digital</span> Dimulai dari{" "}
                                <span className="text-blue-500">Sini</span>.
                            </h1>
                            <p className="text-gray-600 max-w-xl">
                                Bersama kami, ubah ide Anda menjadi solusi kreatif yang relevan. Dari{" "}
                                <span className="font-medium">pembuatan software</span>, <span className="font-medium">desain UI</span>{" "}
                                hingga <span className="font-medium">pelatihan skill digital</span>, kami siap membantu Anda untuk masa
                                depan teknologi.
                            </p>
                            ...
                            <div className="px-8 py-4 mt-6 w-full flex flex-col sm:flex-row items-center justify-between bg-[url(/images/backgrounds/CounterBg.svg)] bg-cover rounded-xl gap-4 sm:gap-0">
                                ...
                                <div className="flex flex-col items-center text-white text-center sm:text-left sm:items-start w-full sm:w-auto">
                                    <p className="font-semibold text-lg md:text-2xl">
                                        <CountUp end={2800} duration={3} separator="." />+
                                    </p>
                        ...
                        <div className="flex flex-col md:flex-row items-center gap-6 md:gap-10">
                            <h2 className="font-bold text-black text-xl md:text-2xl whitespace-nowrap">
                                ...
                                <span className="inline md:block">
                                    <span className="font-normal text-base md:text-xl">100+ Company</span>
                                </span>
                            </h2>
                ...
                <section ref={videoRef} className="container mx-auto px-6 md:px-12 lg:px-16 py-10 opacity-0">
                    <iframe
                ...
                >
                    ...
                    <div className="container mx-auto relative grid grid-cols-1 lg:grid-cols-2 gap-x-8 md:items-start">
                        ...
                        <div className="relative px-6 md:px-12 lg:px-16 flex flex-col items-start gap-6">
                            ...
                            <p className="text-gray-600 max-w-xl">
                                Kami menawarkan solusi kreatif dan teknologi untuk mendukung kebutuhan bisnis dan pengembangan skill
                                Anda. Mulai dari jasa pembuatan website profesional, desain grafis & UI yang menarik, hingga pelatihan
                                skill digital untuk mempersiapkan Anda menghadapi era teknologi yang terus berkembang.
                            </p>
                ...
                >
                    ...
                    <Slider items={events} renderItem={(item, index) => <EventCard event={item} />} />
                </section>
                ...
                >
                    ...
                    <Slider items={courses} renderItem={(item, index) => <CourseCard course={item} />} />
                </section>
                ...
                <section ref={ctaRef} className="px-6 md:px-12 lg:px-16 py-10 w-full flex flex-col gap-6 z-10 opacity-0">
                ...
                <section ref={listMentorRef} className="px-6 md:px-12 lg:px-16 py-10 w-full flex flex-col gap-6 z-10 opacity-0">
                    {/* Gradient animasi */}
                    <div
                    ...
                    <div className="container mx-auto relative mt-12 z-10 text-center">
                        <h2 className="text-3xl font-bold mb-4">Mentor di Kreavoks</h2>
                        <p className="text-gray-600 mb-8">
                            Pilih mentor favoritmu, pelajari dari pengalaman mereka, dan eksplorasi project bareng.
                        </p>
                        ...
                        <div className="flex flex-wrap justify-center gap-6">
                            {mentors?.length > 0 ? (
                                ...
                                <p className="col-span-full text-center text-gray-500">Belum ada mentor tersedia saat ini.</p>
                            )}
                        </div>
                ...
                >
                    <div>
                        ...
                        <p className="text-xl md:text-2xl text-gray-600">100+ Users Satisfied</p>
                    </div>
